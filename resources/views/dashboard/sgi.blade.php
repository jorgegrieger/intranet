  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Adicionar Indicadores</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="{{route('index')}}">Pagina Inicial</a></li>
              <li class="breadcrumb-item active">Adicionar Indicadores</li>
              <div class="card-body">
</div>
            </ol>
          </div><!-- /.col -->
    ...
    <!-- /.content-header -->
    @csrf
    <!-- Main content -->        <form method="post" action="{{route('sgi.salvar')}}" enctype="multipart/form-data">
    @csrf
...
<div class="col-md-5">
<label for="exampleInputEmail1">Selecionar Arquivo:</label>
<br>
                        ...
                        <thead>
                            ...
                            @foreach ($arq as $arquivo)
                                <tr>
                                    ...
                                    <td><a class="btn bg-gradient-danger"  href="javascript: (confirm('Deseja deletar o arquivo : {{$arquivo->nome}}?') ? window.location.href='{{route('deletarSgi',$arquivo->id)}}' : false )">Deletar</a></td>                              

  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">BO PAPER - Cardápios</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
    ...
    <section class="content">
      ...
      <br>
      <label for="exampleInputEmail1">Tipo de Cardápio:</label>
      <select class="custom-select form-control-border" name="tipo" id="exampleSelectBorder">
                    <option value="CardapioM">Cardápio Mensal</option>
                    <option value="CardapioC">Cardápio Ceia</option>
                    <option value="CardapioL">Lanche Pisa</option>
                  </select>
</div>
</div>
<br>
